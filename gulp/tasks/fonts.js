    ...
    fs.readdir(app.path.build.fonts, function (err, fontsFiles) {
        if (fontsFiles) {
            if (!fs.existsSync(fontsFile)) {
                ...
                for (let i = 0; i < fontsFiles.length; i++) {
                    ...
                    if (newFileOnly !== fontFileName) {
                        ...
                        if (fontWeight.toLocaleLowerCase() === 'thin') {
                            ...
                            fontWeight.toLocaleLowerCase() === 'extralight'
                        ) {
                            fontWeight = 200;
                        } else if (fontWeight.toLocaleLowerCase() === 'light') {
                            fontWeight = 300;
                        } else if (
                            fontWeight.toLocaleLowerCase() === 'medium'
                        ) {
                            fontWeight = 500;
                        } else if (
                            fontWeight.toLocaleLowerCase() === 'semibold'
                        ) {
                            fontWeight = 600;
                ...
                //If file exists
                console.log(
                    'scss/fonts.scss is already exists! You must delete it to refresh your fonts.'
                );
            }
        }
    });
